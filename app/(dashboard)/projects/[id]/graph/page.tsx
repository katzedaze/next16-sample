    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      <div className="py-6">
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* グラフ */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow" style={{ height: 'calc(100vh - 250px)' }}>
            <ReactFlow
              nodes={nodes}
              edges={edges}
          ...
          <div className="mt-4 bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">操作方法</h3>
